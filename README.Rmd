...
- Docker image: [Docker Hub](https://hub.docker.com/repository/docker/saskiafreytag/)
...
- Run `docker run -e PASSWORD=delayedarray -p 8787:8787 -d --rm saskiafreytag/saskiafreytag/making_bioconductor_pkg`. Use `-v $(pwd):/home/rstudio` argument to map your local directory to the container.
